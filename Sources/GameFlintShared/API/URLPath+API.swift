...
extension URLPath {
  public static var authRoot: Self = .root(.auth)
  ...
  // MARK: - User Account
  public static var accountRoot: Self = .root(.account)
  ...
  // MARK: - Games
  public static var gamesRoot: Self = .root(.games)
  ...
  // MARK: - Companies
  public static var companiesRoot: Self = .root(.companies)
  ...
  // MARK: - Tags
  public static var tagsRoot: Self = .root(.tags)
  ...
  // MARK: - Genres
  public static var genresRoot: Self = .root(.genres)
  ...
  // MARK: - Platform
  public static var platformsRoot: Self = .root(.platforms)
